...
\newline
Nous avons donc donn\'e en entrée \`{a} Knime notre fichier de 1,7 Go contenant \nombre{10982005} tweets et nous avons obtenu, \`{a} la fin du traitement, un fichier de 250Mo contenant \nombre{1600000} tweets. 
\paragraph{}
...
que nous sommes susceptibles d'avoir dans nos donn\'ees \`a l'aide du module Knime décrit pr\'ec\'edemment 
