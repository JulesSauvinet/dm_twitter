...
\paragraph{}
Nous avons effectu\'e notre d\'etection d'\'ev\`evenents \`a partir d'un fichier de 1,7 Go comportant \nombre{10982005} tweets  r\'ecup\'er\'es sur Twitter. Ces tweets ont \'et\'e post\'es dans l'agglom\'eration newyorkaise ou par des utilisateurs newyorkais du 21 juillet 2015 au 16 novembre 2015. Chaque tweet contient les informations suivantes :
\begin{itemize}
	\item un identifiant
...
Notre jeu de donn\'ees de tweets s'\'etale sur 103 jours. Puisque nous voulons faire de la d\'etection d'\'ev\`enements journaliers et localis\'es, nous avons d\'ecoup\'e notre jeu de donn\'ee initial en 103 sous-ensemble journaliers. Chaque sous-ensemble de tweets contiennent, approximativement, plus de \nombre{15000} tweets.
\newline
